package hk.hku.cs.comp7506_project.Forum.config;
...
/*
    //Debug
    public static final String DOMAIN_NAME = "http://192.168.0.101:8888" + WEBSITE_PATH; // Main domain name
    public static final String MOBILE_DOMAIN_NAME = "http://192.168.0.101:8888" + WEBSITE_PATH; // Domain name of mobile version
    public static final String BASIC_API_URL = "http://192.168.0.100:8888" + WEBSITE_PATH; // Domain name of API
*/


    //Real
    public static final String DOMAIN_NAME = "http://vps48299.vps.ovh.ca:180/~dtslee/Carbon-Forum" + WEBSITE_PATH; // Main domain name
    public static final String MOBILE_DOMAIN_NAME = "http://dslee-carbon.uniforce-dip.com:180/~dtslee/Carbon-Forum" + WEBSITE_PATH; // Domain name of mobile version
    public static final String BASIC_API_URL = "http://167.114.185.220:180/~dtslee/Carbon-Forum" + WEBSITE_PATH; // Domain name of API
